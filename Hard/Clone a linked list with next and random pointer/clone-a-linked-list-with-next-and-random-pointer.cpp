...
class Solution
{
    ...
    {
        // step 1 : creating the clone list of original list 
        ...
        // step 2 : creating a map to store the random pointers
        ...
        {
            oldToNew[orgNode] = cloneNode;      //mapping stored of original node to clone code
        ...
        // step 3 : cloning/setting the random pointers to clone node
        while(orgNode != NULL)
        {
